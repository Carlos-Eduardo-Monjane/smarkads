...
//   var result = [];
//   ps.forEach(function(valor, chave){
//   	if(valor.className == ""){
//   		result.push(chave);
//       }
//   });
...
// }
//
// function createPositionsDiv(){
//   if(detectmob()){
//     var positionsAdUnits = [{positionsAdUnitsMobile}];
//   }else{
//     var positionsAdUnits = [{positionsAdUnitsDesktop}];
//   }
//
//   var ps = getParagraphs();
//   Object.values(positionsAdUnits).forEach(function(position){
//   	position = position.split("x");
//   	var Insertposition = false;
//       for(i=0; i <= ps.length; i++){
//     		if(Insertposition == false && (i/ps.length*100) > position[0]){
//             	document.querySelectorAll("p")[ps[i]].innerHTML += "<center><div id='"+position[1]+"'></div></center>";
//     			Insertposition = true;
//         }
//       }
//   });
