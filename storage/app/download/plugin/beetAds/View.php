    ...
    <script>
      jQuery(document).ready(function($) {
        $("#login").click(function(){
          ...
          $.get("https://painel.beetads.com/painel/admin/admanager/loginplugin/NULL/"+email+"/"+password, function(data, status){
            if(data == 1){
              $("#loginForm").submit();
            }else{
  ...
  public function Reports()
  {
    ...
    jQuery(document).ready(function($) {
      ...
      $("#getData").click(function(){
        ...
        $.get("https://painel.beetads.com/painel/admin/admanager/datapublisher/NULL/"+startDate+"/"+endDate, function(data, status){
      ...
      $("#login").click(function(){
        ...
        $.get("http://localhost/painel/admin/admanager/loginplugin/NULL/"+email+"/"+password, function(data, status){
          // alert(data);
        });
      });
      ...
      <script>
        jQuery(document).ready(function($) {
          $("#login").click(function(){
            var email = $("#email").val();
            var password = $("#password").val();
            $.get("http://localhost:8000/run/plugin/login-adm/"+email+"/"+password, function(data, status){
              if(data == 1){
