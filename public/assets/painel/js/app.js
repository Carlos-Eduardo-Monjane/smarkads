    ...
    if (apexChart.length > 0) {
        ...
        var analytics7 = jQuery('#analytics7')
         ...
         var stockmarketdemo4 = jQuery('#stockmarketdemo4')
           ...
           // cryptodemo2
           var cryptodemo200 = jQuery('#cryptodemo200')
           if (cryptodemo200.length > 0) {
           ...
           var chart = new ApexCharts(
              document.querySelector("#cryptodemo200"),
              options
           );
    ...
    $(function(){
        ...
        if (dataTable.length > 0) {
            $('#datatable').DataTable({
                ...
                "bSortable": true,
                "language": {
                    "sInfo": "Linhas _START_ a _END_ de _TOTAL_",
                    "oPaginate": {
                      "sFirst": "Primeira", "sLast": "Anterior", "sNext": "Próxima", "sPrevious": "Anterior"
                    },
                  }
                });
        }
