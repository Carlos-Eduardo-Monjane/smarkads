...
abstract class StandardController extends BaseController {
  ...
  public function sendEmail($template, $params, $subject, $email, $responsable = "contato@monetizerads.com"){
    Mail::send("emails.$template",$params, function ($m) use($subject, $email, $responsable){
      $m->from($responsable, "Monetizer Ads");
