    ...
    <div class="mdl-grid">
        ...
        <div class="mdl-cell mdl-cell--4-col blue boxLoginPro">
            ...
            <form method="POST" action="{{ route('password.update') }}">
               ...
               <p style="margin-bottom: 30px;">Preencha os dados abaixo para continuar com a recuperação da sua senha.</p>
               ...
               <button class="btnSignUp" type="submit"><i class="fas fa-sign-in-alt"></i>   &nbsp;&nbsp; RESETA SENHA</button>
