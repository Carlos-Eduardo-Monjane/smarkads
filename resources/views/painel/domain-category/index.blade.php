    ...
    <div class="card card-statistics">
      <div class="card-header">
        <div class="card-heading">
          <h4 class="card-title">Domínio Categoria</h4>
          <br>
          ...
          <table class="table mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="/{{$principal}}/{{$rota}}/show/{{$dado->$primaryKey}}" class="btn btn-icon btn-round btn-secondary" title="Atualizar/Visualizar">
