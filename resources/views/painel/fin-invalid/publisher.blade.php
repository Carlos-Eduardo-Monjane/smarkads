		  ...
		  <table class="table mb-0">
			...
			<tbody>
              ...
              <tr>
                ...
                <td>$ {{Helper::moedaView($dado['total'])}} <?php $total +=$dado['total']; ?></td>
                <td>
					...
					<a href="#" 
					   ...
					   style="float:right">PAGAR</a></td>
					<?php } ?>
              </tr>
			  <tr>
				<td id="{{$dado['id_user']}}" colspan="5" style="background:#f7f6f7; padding:10px 0;display:none;">
			  ...
			  <tr>
				...
				<td colspan="2"><strong>$ <?php echo Helper::moedaView($total); ?></strong></td>
			  </tr>
            </tbody>
		  ...
		  <table class="table mb-0">
			...
			<tbody>
              ...
              <tr>
                ...
                <td>$ {{Helper::moedaView($dado['total'])}} <?php $total_prev+=$dado['total'] ?></td>
                <td>
					<?php if($dado['total'] > 100){ ?>
					<a href="#" 
					   data-id_user="{{$dado['id_user']}}" 
