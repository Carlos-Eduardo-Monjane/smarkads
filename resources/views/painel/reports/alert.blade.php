...
<div class="row">
  <div class="col-md-12">
    <div class="card card-statistics">
      ...
      <div class="card-body">
        <form method="POST" action="/{{$principal}}/{{$rota}}/filter/alert" accept-charset="UTF-8" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-3">
              <div class="form-row">
            ...
            <tbody>
              ...
              @forelse($data as $dado)
                ...
                @if($dado->impressions != 0 && $dado->earnings != 0)
                  <?php $ecpm = number_format((($dado->earnings/$dado->impressions)*1000),2,',','.'); ?>
                @else
                  <?php $ecpm = 0; ?>
                @endif
                <?php $viewability = number_format($dado->active_view_viewable,2); ?>
                @if($dado->ctr > 1 || $ecpm > 10 || $viewability < 50)
                  <tr>
                    <td>{{$dado->site}}</td>
