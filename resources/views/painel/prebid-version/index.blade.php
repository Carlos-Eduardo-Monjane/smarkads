    ...
    <div class="card card-statistics">
      <div class="card-header">
        <div class="card-heading">
          <h4 class="card-title">Prebid Versão</h4>
          <br>
          ...
          <table class="table mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  @if($dado->enabled == 1)
                  <a href="/{{$principal}}/{{$rota}}/enable-version/{{$dado->$primaryKey}}" class="btn btn-icon btn-round btn-success" title="Atualizar/Visualizar">
                    <i class="fa fa-check"></i>
                  </a>
                  @else
                  <a href="/{{$principal}}/{{$rota}}/enable-version/{{$dado->$primaryKey}}" class="btn btn-icon btn-round btn-danger" title="Atualizar/Visualizar">
                    <i class="fa fa-check"></i>
                  </a>
                  @endif
                </td>
